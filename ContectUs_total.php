...
// Get contact messages from JSON file
$messages = getContactMessages();
$contactCount = count($messages);
?>
...
<title>Contact Messages - EditX Studio</title>
...
<section class="manage-section">
  <h1><i class="fas fa-envelope" style="color:#ffffff;"></i> Contact Messages</h1>
  ...
  <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; flex-wrap: wrap; gap: 10px;">
    <h2 style="margin: 0; color: #ffffff; text-shadow: 0 0 15px rgba(255, 255, 255, 0.2); flex: 1; min-width: 200px;">
      <i class="fas fa-list" style="color:#ffffff;"></i> All Messages (Total: <?php echo $contactCount; ?>)
    </h2>
